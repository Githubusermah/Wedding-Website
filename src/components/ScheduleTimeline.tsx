...
export default function ScheduleTimeline() {
  ...
  const scheduleEvents = [
    ...
    },
    {
      time: "۰۸:۰۰ شب",
      title: "شب خینه",
      description: "آیین سنتی و با شکوه خینه‌گذاری",
      icon: <Sparkle size={18} className="text-[var(--gold-dark)]" />,
    },
    {
      time: "۰۹:۰۰ شب",
      title: "آیین شرعی عقد نکاح",
      description: "لحظهٔ مقدس ثبت پیوند و شهود",
      icon: <Heart size={18} className="text-[var(--gold-dark)]" />,
    },
    {
      time: "۱۰:۰۰ شب",
      title: "صرف طعام",
      description: "پذیرایی شام فاخر و بوفهٔ کامل غذاهای اصیل افغانی",
      icon: <ForkKnife size={18} className="text-[var(--gold-dark)]" />,
    },
    {
      time: "۱۱:۰۰ شب",
      title: "برش کیک",
      description: "عکس‌های یادگاری، بریدن کیک و شادمانی محفل",
