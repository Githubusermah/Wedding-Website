  ...
  const guideTopics = [
    {
      ...
      content:
        "تالار ستاره شهر کابل دارای پارکینگ اختصاصی سرپوشیده و امن برای تمام مهمانان گرامی می‌باشد. پرسونل راهنما در ورودی تالار جهت هدایت خودروها مستقر خواهند بود.",
    },
    {
      id: "dresscode",
      title: "پوشش پیشنهادی",
