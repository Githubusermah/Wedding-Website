export const event = {
  ...
  venueName: "صالون عروسی کاخ سلیمان",
  venueNameEn: "Sulaiman Wedding Hall",
  venueShortName: "صالون عروسی کاخ سلیمان، کابل",
  venueAddressFa: "کابل، صالون عروسی کاخ سلیمان",
  cityFa: "کابل",
  mapsUrl: "https://www.google.com/maps/search/?api=1&query=Sulaiman+Wedding+Hall+Kabul+Afghanistan",
  latitude: 34.528,
  longitude: 69.172,
