export const event = {
  ...
  venueName: "تاج کانتیننتال",
  venueNameEn: "Taj Continental",
  venueShortName: "تاج کانتیننتال، کابل",
  venueAddressFa: "کابل، تاج کانتیننتال",
  cityFa: "کابل",
  mapsUrl: "https://www.google.com/maps/search/?api=1&query=Taj+Continental+Kabul+Afghanistan",
  latitude: 34.528,
  longitude: 69.172,
