export const event = {
  ...
  venueName: "تالار عروسی سیتی استار",
  venueNameEn: "City Star Wedding Hall",
  venueShortName: "تالار عروسی سیتی استار، کابل",
  venueAddressFa: "کابل، تالار عروسی سیتی استار",
  cityFa: "کابل",
  mapsUrl: "https://www.google.com/maps/search/?api=1&query=City+Star+Wedding+Hall+Kabul+Afghanistan",
  latitude: 34.528,
  longitude: 69.172,
